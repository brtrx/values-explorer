...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Value Predicate Forms Table */}
      <section className="py-12 border-t">
        <div className="container">
          <div className="max-w-5xl mx-auto">
            <h2 className="font-serif text-2xl font-bold mb-2 text-center">Values as Action</h2>
            <p className="text-center text-muted-foreground mb-6 text-sm">Preferred predicate forms — how each value expresses itself in first-person</p>
