...
export const ARCHETYPES: Archetype[] = [
  // ============ FICTIONAL CHARACTERS ============
  {
    ...
    valueProfile: { UNC: 3, UNT: 3, SDT: 3, BEC: 2, ACM: 1, HUM: 1, FAC: 1, POD: -1, POR: -2 },
    category: 'fictional',
  },
  {
    ...
    valueProfile: { SDT: 3, ACM: 3, BED: 3, BEC: 2, COR: 2, UNC: 1, SDA: 1, FAC: 1, HED: -1 },
    category: 'fictional',
  },
  {
    name: 'Leslie Knope',
    description: 'A relentlessly driven public servant whose ambition and genuine love for her community are inseparable. Combines extraordinary self-direction with deep care for others — every project is both a personal mission and a legacy for Pawnee.',
    ...
    valueProfile: { BEC: 3, SDT: 3, SDA: 3, ACM: 3, BED: 2, SES: 2, UNC: 2, TRD: 1, STI: 1, POD: 1, HUM: -2 },
    category: 'fictional',
  },
  {
    name: 'Spock',
    ...
    valueProfile: { SDT: 3, COR: 3, ACM: 2, HUM: 2, UNT: 1, BED: 1, HED: -3 },
    category: 'fictional',
  },
  {
    name: 'Tony Stark',
    ...
    valueProfile: { ACM: 3, SDA: 3, SDT: 2, STI: 2, FAC: 2, HED: 1, POR: 1, HUM: -2, COR: -2, BED: -1 },
    category: 'fictional',
  },
  {
    name: 'Forrest Gump',
    ...
    valueProfile: { BED: 3, TRD: 3, HUM: 3, BEC: 2, COR: 2, SES: 1, POD: -2, ACM: -1, STI: -1 },
    category: 'fictional',
  },
  {
    name: 'The Joker',
    description: "An agent of chaos who doesn't want power — he wants to expose the fragility of social order. Rejects every value structure including dominance, finding meaning only in destruction and the spectacle of others abandoning their principles.",
    ...
    valueProfile: { STI: 3, SDA: 3, SDT: 2, HED: 2, BEC: -3, UNC: -3, SES: -3, COR: -3, TRD: -3, HUM: -2, POD: -1 },
    category: 'fictional',
  },
  {
    name: 'Yoda',
    ...
    valueProfile: { SDT: 3, HUM: 3, UNT: 2, UNN: 2, TRD: 2, UNC: 2, BEC: 1, POD: -2, FAC: -2, POR: -2 },
    category: 'fictional',
  },
  {
    ...
    valueProfile: { POD: 3, ACM: 2, SDA: 2, FAC: 2, STI: 1, UNC: 1, HUM: -2, COR: -2 },
    category: 'fictional',
  },
  {
    name: 'Ron Swanson',
    ...
    valueProfile: { SDA: 3, SDT: 2, TRD: 2, SEO: 2, HED: 1, POR: 1, COR: -3, UNC: -2 },
    category: 'fictional',
  },
  {
    name: 'Elle Woods',
    ...
    valueProfile: { ACM: 3, BEC: 2, FAC: 2, HED: 2, BED: 2, SDA: 2, UNC: 1, HUM: -1, SEO: -1 },
    category: 'fictional',
  },
  {
    name: 'Walter White',
  ...
  },
  {
    ...
    valueProfile: { POD: 3, SDT: 3, FAC: 3, HED: 2, STI: 2, ACM: 2, BEC: -3, HUM: -3, UNC: -3, COR: -2 },
    category: 'fictional',
  },
  {
    name: 'Mary Poppins',
    ...
    valueProfile: { BEC: 3, SDT: 3, BED: 2, COR: 2, STI: 2, UNN: 1, HUM: -1, POD: -1 },
    category: 'fictional',
  },
  {
    name: 'Jack Sparrow',
    ...
    valueProfile: { SDA: 3, STI: 3, SDT: 2, HED: 2, POR: 1, COR: -3, TRD: -2, BED: -2 },
    category: 'fictional',
  },
  ...
  },
  {
    ...
    valueProfile: { SDT: 3, STI: 3, ACM: 2, UNN: 2, SDA: 2, HED: 1, COR: -2, BED: -1, TRD: -1 },
    category: 'historical',
  },
  {
  ...
  },
  {
    ...
    valueProfile: { UNC: 3, UNT: 3, HUM: 3, SDA: 2, BEC: 2, TRD: 2, POD: -3, POR: -3, HED: -2 },
    category: 'historical',
  },
  {
    name: 'Cleopatra',
  ...
  },
  {
    ...
    valueProfile: { POD: 3, ACM: 3, FAC: 3, SDA: 2, POR: 2, SES: 2, HUM: -2, TRD: -1, UNT: -1, BEC: -1 },
    category: 'historical',
  },
  {
    name: 'Mother Teresa',
  ...
  },
  {
    ...
    valueProfile: { SDT: 3, ACM: 3, UNC: 2, STI: 2, SDA: 2, HUM: 1, FAC: -1, HED: -1 },
    category: 'historical',
  },
  {
    ...
    valueProfile: { UNC: 3, UNT: 3, BED: 2, HUM: 2, SES: 2, ACM: 1, POD: 1 },
    category: 'historical',
  },
  {
    name: 'Nikola Tesla',
  ...
  },
  {
    ...
    valueProfile: { TRD: 3, COR: 3, SES: 3, FAC: 3, BED: 2, POD: 2, SEO: 2, STI: -2, SDA: -2 },
    category: 'historical',
  },
  {
    ...
    valueProfile: { SDT: 3, ACM: 2, UNC: 2, SDA: 2, BEC: 2, HED: 1, FAC: 1, STI: 1, TRD: -1, COR: -1 },
    category: 'historical',
  },
  {
    name: 'Frida Kahlo',
    ...
    valueProfile: { SDA: 3, SDT: 3, STI: 2, FAC: 2, UNC: 1, TRD: 1, COR: -2, HUM: -1 },
    category: 'historical',
  },
  {
    ...
    valueProfile: { SES: 3, TRD: 3, POD: 2, SDA: 2, ACM: 2, FAC: 2, HED: 1, HUM: -1, UNT: -1 },
    category: 'historical',
  },
  ...
  // ============ SUPERHEROES & COMICS ============
  {
    ...
    valueProfile: { BED: 3, BEC: 2, UNC: 2, TRD: 2, SDA: 2, SES: 2, COR: 1, POD: -2, HED: -1 },
  ...
  },
  {
    ...
    valueProfile: { UNC: 3, BEC: 2, POD: 2, TRD: 2, SDA: 2, STI: 1, HUM: 1, POR: -2, FAC: -1 },
    category: 'superheroes',
  },
  {
    name: 'Batman',
    ...
    valueProfile: { SDA: 3, ACM: 3, SDT: 2, POD: 2, BEC: 2, SES: 2, HED: -2, SEO: -2, COR: -1 },
    category: 'superheroes',
  },
  {
    name: 'Spider-Man',
  ...
  },
  {
    ...
    valueProfile: { TRD: 3, POD: 2, SES: 2, UNC: 2, SDA: 2, HUM: 2, FAC: 1, ACM: 1, POR: -1, HED: -1 },
    category: 'superheroes',
  },
  {
    name: 'Superman',
  ...
  },
  {
    ...
    valueProfile: { SES: 3, POD: 3, SDA: 2, BEC: 2, FAC: 1, UNT: -3, UNC: -2, COR: -2, HUM: -1 },
    category: 'superheroes',
  },
  {
    name: 'Professor X',
    ...
    valueProfile: { UNT: 3, UNC: 3, SDT: 2, BEC: 2, HUM: 2, BED: 1, SES: 1, STI: -1 },
    category: 'superheroes',
  },
  {
    name: 'Wolverine',
  ...
  },
  {
    ...
    valueProfile: { SDT: 3, SEO: 3, COR: 2, UNC: 2 },
    category: 'superheroes',
  },
  {
    name: 'Deadpool',
    ...
    valueProfile: { STI: 3, SDA: 3, HED: 3, SDT: 2, FAC: -2, COR: -3, TRD: -2, HUM: -1 },
    category: 'superheroes',
  },
  {
    name: 'Captain Marvel',
  ...
  },
  {
    ...
    valueProfile: { SDA: 3, HED: 3, SDT: 2, STI: 2, POR: 2, FAC: 1, COR: -3, TRD: -2, BED: -1, BEC: -1 },
    category: 'superheroes',
  },
  ...
  },
  {
    ...
    valueProfile: { SDT: 3, TRD: 3, ACM: 2, POD: 2, SES: 2, FAC: 1, HED: -2, HUM: -1 },
    category: 'mythological',
  },
  {
    name: 'Aphrodite',
    ...
    valueProfile: { HED: 3, FAC: 2, STI: 2, BEC: 2, POD: 1, COI: -1, ACM: -2, SDT: -1 },
    category: 'mythological',
  },
  {
    name: 'Prometheus',
  ...
  },
  {
    ...
    valueProfile: { POD: 3, POR: 3, FAC: 3, HED: 2, SES: 2, HUM: -3, COR: -2, UNT: -1 },
    category: 'mythological',
  },
  {
    name: 'Loki',
    ...
    valueProfile: { STI: 3, SDA: 3, SDT: 2, HED: 2, ACM: 1, FAC: 1, COR: -3, TRD: -3, BED: -2, HUM: -1 },
    category: 'mythological',
  },
  {
    name: 'Hestia',
  ...
  },
  {
    ...
    valueProfile: { HED: 3, SDA: 2, POD: 2, FAC: 2, BEC: 2, STI: 2, COR: -2, HUM: -1 },
    category: 'mythological',
  },
  {
    name: 'Anubis',
    ...
    valueProfile: { COR: 3, UNC: 2, TRD: 2, SES: 2, SDT: 2, HUM: 2, STI: -2, HED: -1 },
    category: 'mythological',
  },
  {
    name: 'Dionysus',
  ...
  },
  {
    ...
    valueProfile: { POD: 3, SDA: 3, TRD: 2, UNC: 2, STI: 2, BEC: 1, HUM: -2, COR: -1 },
    category: 'mythological',
  },
  ...
  },
  {
    ...
    valueProfile: { UNN: 3, HUM: 3, UNC: 2, BEC: 2, UNT: 2, SDT: 2, TRD: 1, POD: -1, POR: -2 },
    category: 'literary',
  },
  {
    name: 'Atticus Finch',
  ...
  },
  {
    ...
    valueProfile: { SDT: 3, STI: 3, ACM: 2, SDA: 2, FAC: 1, BEC: -2, BED: -1, COR: -1, HED: -1 },
    category: 'literary',
  },
  {
    name: 'Jane Eyre',
    ...
    valueProfile: { SDA: 3, SDT: 2, BED: 2, BEC: 2, HUM: 2, UNC: 2, TRD: 1, FAC: -2, POR: -1 },
    category: 'literary',
  },
  {
    name: 'Jay Gatsby',
  ...
  },
  {
    ...
    valueProfile: { BED: 3, SDA: 3, BEC: 2, SEO: 2, UNC: 2, HUM: 1, POD: -2, FAC: -2 },
    category: 'literary',
  },
  {
    ...
    valueProfile: { SDT: 3, BEC: 2, UNT: 2, SDA: -1, SEO: -1, COR: -3, FAC: -3, ACM: -2, TRD: -1 },
    category: 'literary',
  },
  {
  ...
  },
  {
    ...
    valueProfile: { SDA: 3, ACM: 2, POD: 2, FAC: 2, STI: 2, POR: 2, SDT: 2, HUM: -3, BEC: -3, BED: -2, UNC: -2, COR: -1 },
    category: 'literary',
  },
  {
    name: 'Anne Shirley',
    ...
    valueProfile: { SDT: 3, BEC: 2, BED: 2, STI: 2, UNN: 2, HED: 2, POD: -2, COR: -1 },
    category: 'literary',
  },
  {
    name: 'Captain Ahab',
  ...
  },
  {
    ...
    valueProfile: { POD: 3, ACM: 3, SDA: 2, FAC: 2, POR: 2, HUM: -3, BEC: -3, BED: -2, UNC: -2, COR: -1 },
    category: 'literary',
  },
